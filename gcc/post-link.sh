...
echo "completed 1" > /home/conda/messages.txt
    #
    ...
    echo "completed 2" >> /home/conda/messages.txt
    ...
    echo "completed 3 $c_runtime_obj_files_found" >> /home/conda/messages.txt
    ...
    echo "completed 4 $c_runtime_obj_files_found" >> /home/conda/messages.txt
    if [ $c_runtime_obj_files_found -ne 1 ]; then
        >&2 echo "*** Can't install the gcc package unless your system has crtXXX.o. ***"
        exit 1
    fi

    echo "completed 5 $c_runtime_obj_files_found" >> /home/conda/messages.txt
    #
    ...
    SPECS_DIR=$(echo "${PREFIX}"/lib/gcc/*/${PKG_VERSION})
    ...
    echo "completed 6 $c_runtime_obj_files_found" >> /home/conda/messages.txt
